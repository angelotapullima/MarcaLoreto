...
class DetailBlog extends StatelessWidget {
  const DetailBlog({Key? key, required this.idBlog}) : super(key: key);
  final String idBlog;
  ...
  Widget build(BuildContext context) {
    ...
    detailBlog.getBlogById(idBlog, false, '');
    return Scaffold(
      appBar: AppBar(
      ...
      body: StreamBuilder(
        stream: detailBlog.blogIDStream,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        (detalle.activateEnglish == '1')
                            ? '${detalle.descriptionBlogEn}'
                            : '${detalle.descriptionBlog}',
