...
import 'package:marca_loreto/src/page/Tabs/Inicio/Blogs/detalle_blog.dart';
      ...
      appBar: AppBar(
        ...
        title: ValueListenableBuilder(
            ...
            builder: (BuildContext context, int data, Widget? child) {
              return Text(
                (provider.activateS.value == 1) ? 'Blog and News' : 'Blog y Noticias',
